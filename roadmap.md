...
### Phase 6. 검증/문서화 (완료: 2026-02-18)
- [x] 테스트 시나리오 정리: 신규 설치, 기존 repo 전환, private repo, 실패 복구.
  - [x] 문서: `docs/phase6-test-scenarios.md`
- [x] 운영 문서 정리: 빠른 시작, 트러블슈팅, 팀 규칙.
  - [x] 문서: `docs/operations-guide.md`
- [x] 완료 기준: 재설치/재현 가능한 문서 기반 온보딩 완료.
  - [x] 문서 인덱스/진입점 정리: `docs/README.md`, `README.md`
...
- [x] `wt status --json` 스키마를 병렬 실행 상태 모델에 맞춰 확장.
  - [x] 문서: `docs/api-status-schema.md`
